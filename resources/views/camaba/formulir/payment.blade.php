              ...
              <div class="space-y-4">
                ...
                <div class="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  <div class="flex items-center gap-4">
                    <div
                      class="w-12 h-8 bg-slate-200 rounded flex items-center justify-center font-bold text-xs text-slate-600">
                      BCA</div>
                    <div>
                  ...
                  <div class="text-right">
                    ...
                    <p class="font-bold text-slate-800 text-sm">Administrasi Universitas Annuqayah</p>
                  </div>
                </div>
          ...
          <div class="bg-amber-50 border border-amber-200 rounded-3xl p-6 flex gap-4">
            ...
            <div>
              ...
              <ul class="text-sm text-amber-800 list-disc list-inside space-y-1">
                <li>Pastikan nominal transfer sesuai hingga 3 digit terakhir (jika ada).</li>
          ...
          <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden sticky top-28">
            <div class="p-6 border-b border-slate-100 bg-slate-50/50">
              <h2 class="text-lg font-bold text-slate-800 flex items-center gap-2">
                <span class="material-symbols-outlined text-indigo-500">cloud_upload</span>
                Konfirmasi
              </h2>
            </div>
            <div class="p-6">
              <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                  ...
                  <div class="relative group">
                    ...
                    <div
                      class="border-2 border-dashed border-slate-200 group-hover:border-indigo-400 group-hover:bg-indigo-50 transition-all rounded-2xl p-8 text-center">
                      <span
                        class="material-symbols-outlined text-slate-400 group-hover:text-indigo-500 text-4xl mb-2 transition-colors">image</span>
                      <p class="text-xs text-slate-500 font-medium">Klik atau seret file ke sini</p>
                ...
                <div class="mb-6">
                  <label class="block text-sm font-semibold text-slate-700 mb-2">Nama Pengirim di Rekening</label>
                  <input type="text" name="nama_pengirim" placeholder="Contoh: Budi Santoso"
                    class="w-full px-4 py-3 rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all text-sm">
                </div>

                <button type="submit"
                  class="w-full py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 shadow-lg shadow-slate-200 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2">
                  Kirim Konfirmasi
