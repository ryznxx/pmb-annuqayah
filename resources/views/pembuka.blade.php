          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-12 gap-x-4 relative z-10">
            ...
            <a href="/formulir">
              <div class="flex flex-col items-center text-center group">
                ...
                <p class="text-xs text-slate-500 leading-relaxed px-2">Lengkapi data diri dan unggah berkas asli pada
                  menu
                  Profil Camaba.</p>
              </div>
            </a>
            <a href="/formulir/pembayaran">
              <div class="flex flex-col items-center text-center group">
                ...
                <p class="text-xs text-slate-500 leading-relaxed px-2">Bayar tagihan pendaftaran melalui transfer
            ...
            <div class="flex flex-col items-center text-center group">
              ...
              <p class="text-xs text-slate-500 leading-relaxed px-2">Gunakan akun Anda untuk masuk ke sistem ujian
      ...
      <div
        ...
        <div class="flex items-center gap-4 mb-4 md:mb-0">
          ...
          <div>
            ...
            <p class="text-sm text-indigo-700 font-medium opacity-80">Hubungi Helpdesk PMB jika mengalami kendala
              sistem.</p>
          </div>
        </div>
