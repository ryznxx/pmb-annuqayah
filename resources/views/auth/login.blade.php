          ...
          <div class="text-center pt-4">
            <p class="text-slate-500 text-sm font-medium">
              ...
              <a href="{{ route('register') }}"
                class="text-indigo-600 font-bold hover:underline decoration-2 underline-offset-4">Daftar Sekarang</a>
            </p>
          </div>
        </form>
      </div>

      <div class="hidden lg:flex lg:w-[55%] bg-slate-900 relative items-center justify-center p-20 overflow-hidden">
        ...
        <div class="relative z-10 w-full">
          ...
          <h3 class="text-5xl font-black text-white mb-6 leading-tight">Mulai Perjalanan <br>Akademik Anda.</h3>
          ...
          <div class="mt-12 space-y-4 max-w-sm">
            <div class="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 flex items-center gap-4">
              <div
