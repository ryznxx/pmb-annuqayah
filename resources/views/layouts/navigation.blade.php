...
<nav class="bg-white border-b border-slate-200 sticky top-0 z-40" x-data="{ sideStatus: false }">
  <div class="max-w-7xl mx-auto py-3 flex justify-between items-center lg:px-0 px-4">
      ...
      <div class="hidden lg:flex items-center gap-6">
        ...
        @if (Auth::user()->isAdmin())
          <a href="{{ route('admin.dashboard') }}"
            class="text-sm text-slate-600 font-semibold hover:text-indigo-600 transition">Dashboard Admin</a>
        @else
    ...
    <div class="flex items-center gap-4">
      ...
      <button @click="sideStatus = true" class="lg:hidden p-2 text-slate-600 hover:bg-slate-100 rounded-lg transition">
